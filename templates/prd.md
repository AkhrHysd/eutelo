...
purpose: >
  {FEATURE} 機能の目的・KPI・スコープ・成功基準を定義し、
...
- Behavior: `../{FEATURE}/BEH-{FEATURE}.md`  
- Design: `../../architecture/design/{FEATURE}/DSG-{FEATURE}.md`  
- ADR: `../../architecture/adr/{FEATURE}/ADR-{FEATURE}-0001.md`  
